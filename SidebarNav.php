 ...
 * @since 2.0
 */
class SidebarNav extends Widget
{
    /**
    ...
    public function init()
    {
        ...
        if ($this->collapseCaret === null) {
            $this->collapseCaret = Html::tag('b', '', ['class' => 'caret']);
        }
    ...
    public function renderItem($item)
    {
        ...
        $url = ArrayHelper::getValue($item, 'url', '#' . $id);
        ...
        $label = Html::tag("i", $icon, ["class" => "material-icons"]) . Html::tag("p", $label);
        $items = $items == "" ? $items : Html::tag("div", $items, ["id" => $id, "class" => "collapse"]);
     ...
     * @since 2.0.1
     */
    protected function renderCollapse($items, $parentItem)
    {
      $lines = [];
